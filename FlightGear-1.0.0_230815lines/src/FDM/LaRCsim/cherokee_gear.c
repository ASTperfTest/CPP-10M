...
$Header: /var/cvs/FlightGear-0.9/source/src/FDM/LaRCsim/cherokee_gear.c,v 1.1.1.1 2002-09-10 01:14:01 curt Exp $
$Log: cherokee_gear.c,v $
...
void cherokee_gear()
{
char rcsid[] = "$Id: cherokee_gear.c,v 1.1.1.1 2002-09-10 01:14:01 curt Exp $";
