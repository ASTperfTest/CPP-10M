 ...
 *
 * $Id: ls_interface.c,v 1.2.2.1 2007-03-01 17:53:27 mfranz Exp $
...
$Header: /var/cvs/FlightGear-0.9/source/src/FDM/LaRCsim/ls_interface.c,v 1.2.2.1 2007-03-01 17:53:27 mfranz Exp $
...
void ls_stamp( void ) {
    char rcsid[] = "$Id: ls_interface.c,v 1.2.2.1 2007-03-01 17:53:27 mfranz Exp $";
    char revid[] = "$Revision: 1.2.2.1 $";
    char dateid[] = "$Date: 2007-03-01 17:53:27 $";
    struct tm *nowtime;
    time_t nowtime_t;
    long date;
