 ...
 *  $Revision: 1.5 $
 *
 *  last change: $Author: rt $ $Date: 2006/10/27 18:25:30 $
 *
...
#ifndef _SD_DRTXTOB_HXX
#define _SD_DRTXTOB_HXX
...
class SdDrawTextObjectBar : public SfxShell
{
	SfxItemPool&		rPool;
...
public:
	...
	SFX_DECL_INTERFACE(SD_IF_SDDRAWTEXTOBJECTBAR);
	 ...
	 SdDrawTextObjectBar( SdViewShell* pSdViewShell, SfxItemPool& rItemPool,
							SdView* pSdView );
	~SdDrawTextObjectBar();
