 ...
 *
 *  $RCSfile: objstor.cxx.org,v $
 *
 *  $Revision: 1.6 $
 *
 *  last change: $Author: vg $ $Date: 2007/10/23 13:38:12 $
 *
...
/*N*/ 		{
/*N*/ 			aBaseURL = StaticBaseUrl::GetBaseURL();
...
/*N*/         	if ( !GetError() )
/*N*/         	{
/*N*/             	const String aOldURL( StaticBaseUrl::GetBaseURL() );
/*N*/             	if( aBaseURL.Len() ) StaticBaseUrl::SetBaseURL( aBaseURL );
/*N*/             	pImp->nLoadedFlags = 0;
/*N*/             	bOk = xStor.Is() && LoadOwnFormat( *pMed );
/*N*/             	StaticBaseUrl::SetBaseURL( aOldURL );
/*N*/             	if ( bOk )
/*N*/             	{
...
//STRIP003/*?*/ 		const String aOldURL( StaticBaseUrl::GetBaseURL() );
//STRIP003/*?*/ 		if( aBaseURL.Len() ) StaticBaseUrl::SetBaseURL( aBaseURL );
...
//STRIP003/*?*/ 		}
//STRIP003/*?*/ 
//STRIP003/*?*/ 		StaticBaseUrl::SetBaseURL( aOldURL );
//STRIP003/*?*/ 
...
/*?*/         return sal_False;
/*?*/ 
/*?*/ 	const String aOldURL( StaticBaseUrl::GetBaseURL() );
/*?*/ 	if( GetCreateMode() != SFX_CREATE_MODE_EMBEDDED )
/*?*/ 		if ( ShallSetBaseURL_Impl( rMedium ) )
/*?*/ 			StaticBaseUrl::SetBaseURL( rMedium.GetBaseURL() );
/*?*/ 		else
/*?*/ 			StaticBaseUrl::SetBaseURL( String() );
/*?*/ 
/*?*/     sal_Bool bRet = SaveTo_Impl( rMedium, NULL, sal_False );
/*?*/ 	StaticBaseUrl::SetBaseURL( aOldURL );
/*?*/ 	if( bRet )
/*?*/ 		DoHandsOff();
/*?*/ 	else
/*?*/ 		SetError(rMedium.GetErrorCode());
...
/*N*/ 				StaticBaseUrl::SetBaseURL( aBase );
/*N*/ 			Broadcast( SfxSimpleHint(SFX_HINT_NAMECHANGED) );
/*N*/ 		}
/*N*/ 
...
/*N*/ 			StaticBaseUrl::SetBaseURL( pNewFile->GetBaseURL() );
/*N*/ 		else
/*N*/ 			StaticBaseUrl::SetBaseURL( String() );
/*N*/ 
/*N*/     // distinguish between "Save" and "SaveAs"
/*N*/     pImp-> bIsSaving = sal_False;
/*N*/ 
/*N*/ 	sal_Bool bToOwnFormat = IsOwnStorageFormat_Impl(*pNewFile);
/*N*/ 	if ( bToOwnFormat )
/*N*/ 	{
